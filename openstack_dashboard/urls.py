...
import horizon
from openstack_dashboard.dashboards.vault.custom.views import register_openstack_user
...
######
# Routing for vault staff
######
urlpatterns += patterns(
    '',
    url(r'^vault_register', register_openstack_user, name='vault_register')
)
